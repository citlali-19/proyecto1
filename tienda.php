...
<div class="container-fluid">
    <a class="navbar-brand" href="inicio.php">Mi Estetica</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="modal" data-bs-target="#modal_cart" style="color: green;"><i class="fas fa-shopping-cart"></i> <?php echo $totalcantidad; ?></a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Tinte de cabello" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/tinte.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Tinte de cabello</h5>
                        <p class="card-text">Descripción: Tinte de cabello basico</p>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Corte de cabello" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/descarga.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Corte de cabello</h5>
                        <p class="card-text">Descripción: Corte de cabello para mujer</p>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Maquillaje" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/maquillaje.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Maquillaje</h5>
                        <p class="card-text">Maquillaje sencillo look de dia.</p>
